...
namespace HL7Comparer
{
    public static class Extensions
    {
        ...
        public static IEnumerable<TR> Transform<T1, T2, TR>(this IEnumerable<Tuple<IEnumerable<T1>, IEnumerable<T2>>> source, Func<IEnumerable<T1>, IEnumerable<T2>, IEnumerable<TR>> fn)
        {
        ...
        public static IEnumerable<Tuple<TR, TR>> JoinOn<T, TKey, TR>(this IEnumerable<T> source, IEnumerable<T> dest, Func<T, TKey> selector, Func<T, TR> result)
        {
